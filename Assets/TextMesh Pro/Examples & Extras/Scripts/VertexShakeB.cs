                ...
                for (int i = 0; i < lineCount; i++)
                {
                    ...
                    Vector3 centerOfLine =
                        (textInfo.characterInfo[first].bottomLeft +
                         textInfo.characterInfo[last].topRight) / 2;
                    Quaternion rotation =
                        Quaternion.Euler(0, 0, Random.Range(-0.25f, 0.25f));
                    ...
                    for (int j = first; j <= last; j++)
                    {
                        ...
                        int materialIndex = textInfo.characterInfo[j]
                        ...
                        matrix = Matrix4x4.TRS(Vector3.one, Quaternion.identity,
                        ...
                        matrix = Matrix4x4.TRS(Vector3.one, rotation,
                            Vector3.one);
