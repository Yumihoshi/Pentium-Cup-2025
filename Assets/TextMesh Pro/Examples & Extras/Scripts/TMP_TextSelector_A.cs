...
{
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler,
        IPointerExitHandler
    {
        ...
        private void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                     ...
                     Input.GetKey(KeyCode.RightShift)))
                {
                    ...
                    Color32 c = new((byte)Random.Range(0, 255),
                        (byte)Random.Range(0, 255), (byte)Random.Range(0, 255),
                        255);
                    ...
                    m_TextMeshPro.textInfo.meshInfo[meshIndex].mesh.colors32 =
                        vertexColors;
                }
                ...
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    Vector3 wordPOS =
                        m_TextMeshPro.transform.TransformPoint(m_TextMeshPro
                            .textInfo.characterInfo[wInfo.firstCharacterIndex]
                            .bottomLeft);
                    ...
                    Color32[] vertexColors =
                        m_TextMeshPro.textInfo.meshInfo[0].colors32;
