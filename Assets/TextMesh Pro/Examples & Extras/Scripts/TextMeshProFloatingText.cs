    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (SpawnType == 0)
            {
                ...
                m_floatingText_Transform = m_floatingText.transform;
                m_floatingText_Transform.position =
                    m_transform.position + new Vector3(0, 15f, 0);
                ...
                m_textMeshPro.color = new Color32((byte)Random.Range(0, 255),
            ...
            else if (SpawnType == 1)
            {
                ...
                m_textMesh.GetComponent<Renderer>().sharedMaterial =
                    m_textMesh.font.material;
                m_textMesh.color = new Color32((byte)Random.Range(0, 255),
                    (byte)Random.Range(0, 255), (byte)Random.Range(0, 255),
                    255);
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            float starting_Count =
                Random.Range(5f,
                    20f); // At what number is the counter starting at.
            ...
            {
                current_Count -=
                    Time.deltaTime / CountDuration * starting_Count;

                if (current_Count <= 3)
                    //Debug.Log("Fading Counter ... " + current_Count.ToString("f2"));
                    alpha = Mathf.Clamp(
                        alpha - Time.deltaTime / fadeDuration * 255, 0, 255);

                int_counter = (int)current_Count;
                m_textMeshPro.text = int_counter.ToString();
                //m_textMeshPro.SetText("{0}", (int)current_Count);

                m_textMeshPro.color = new Color32(start_color.r, start_color.g,
                    start_color.b, (byte)alpha);

                // Move the floating text upward each update
                m_floatingText_Transform.position +=
                    new Vector3(0, starting_Count * Time.deltaTime, 0);
        ...
        public IEnumerator DisplayTextMeshFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                m_textMesh.color = new Color32(start_color.r, start_color.g,
                    start_color.b, (byte)alpha);
